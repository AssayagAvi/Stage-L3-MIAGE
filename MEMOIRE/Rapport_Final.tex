...
\subsection{La programmation objet en Python}
...
\subsubsection{Code générique Classe "Lambda" }
...
def __init__(self, name, age) :
     ...
     self.age = age
\end{verbatim}
\subsubsection{Exemple de class : Pullover}
